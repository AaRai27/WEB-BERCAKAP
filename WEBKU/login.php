...
if(isset($_POST['nama'])){
    ...
    $sql= "SELECT * FROM mahasiswa WHERE nama ='$nama'AND nim ='$nim'";
...
<body>
  ...
  <li><a class="active" href="login.php"><span class="glyphicon glyphicon-plus"></span> Log In </a></li>
  ...
  <p style="text-align: right;font-size: 20px;color: white;padding-right: 40px;margin-top: 3px; text-transform: capitalize;font-family: verdana;"><U> login form </U></p>
</ul>
